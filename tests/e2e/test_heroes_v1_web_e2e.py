"""E2E smoke test: /v1/heroes/form and /v1/heroes/components.js against the live api."""
...
def test_hero_v1_components_js_serves_javascript(page: Page, base_url: str) -> None:
    ...
    response = page.request.get(f"{base_url}/v1/heroes/components.js")
    assert response.ok
